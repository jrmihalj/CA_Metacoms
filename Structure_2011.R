...
caterplot(bundle_2covB, parms="p.detect", col="black", val.lim=c(0,1),
...
caterplot(bundle_2covB, parms="betas", col="black", labels=betalabs)

quartz(height=4, width=6)
caterplot(bundle_2covB, parms="mean.beta.post", col="black",
          labels=c("Amph_RA1", "Amph_RA2"), las=0,
          horizontal=F)

quartz(height=4, width=6)
caterplot(bundle_2covB, parms="sd.beta.post", col="black",
          labels=c("Amph_RA1", "Amph_RA2"), las=0,
          horizontal=F)
