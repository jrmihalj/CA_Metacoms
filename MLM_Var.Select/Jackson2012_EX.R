...
#New? Extract deviance
LL <- c(getME(z, "devcomp")$cmp[8], getME(z1, "devcomp")$cmp[8], getME(z2, "devcomp")$cmp[8], getME(z3, "devcomp")$cmp[8], getME(z4, "devcomp")$cmp[8], getME(z5, "devcomp")$cmp[8])
...
#New:
MLM.fitted <- array(z@resp$eta - z.r@resp$eta, c(nsite,nspp))
